"""
Source:
https://github.com/thodan/epos/blob/master/epos_lib/fragment.py
"""
...
def fragmentation_fps(vertices, num_frags):
  ...
  frag_centers = [np.mean(vertices, 0)]
  ...
  # Note: This information can in fact be maintained during the FPS algorithm (?)
  nn_index = spatial.cKDTree(frag_centers)
